        ...
        <div className="h-full p-6 flex flex-col gap-8 md:p-8 md:gap-10 md:flex-row md:justify-between md:items-center">
          <div className="flex flex-col gap-1 items-center md:gap-4 md:w-1/2">
            ...
            <div className="flex flex-col gap-4">
              <span className="text-xl font-bold">Sander dos Santos Zuchinalli</span>
              <span>
                I’m a software engineer specialized in building (occasionally designing)
                excellent digital experiences, which I tend to switch between
                backend and frontend technologies at
                NTT Data.
              </span>
            </div>
          </div>
